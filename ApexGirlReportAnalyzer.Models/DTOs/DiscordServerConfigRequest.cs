...
{
    /// <summary>
    /// Unique identifier for the Discord server (guild). This is used to associate the server's configuration and quota with the correct Discord server.
    /// </summary>
    ...
    /// <summary>
    /// LogChannelId is the ID of the channel where the bot will send notifications about new uploads, processing status, and any issues that arise. 
